...
export default function PrivacyPage() { return <InfoPage eyebrow="Legal" title="Privacy Policy" intro="This policy explains what is stored locally and what is requested over the network. Last updated 24 August 2026." sections={[
  ...
  { title: "Network requests", body: "Luffy TV requests catalog metadata, artwork, captions, playable sources, and app-version policy from Luffy TV services and content providers. Those services may process standard technical data such as IP address, request time, device information, and error logs." },
